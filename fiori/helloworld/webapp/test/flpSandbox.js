		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comaghelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaghelloworld-display": {
								"semanticObject": "comaghelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ag.helloworld",
									"url": sap.ui.require.toUrl("com/ag/helloworld")
								}
							}
						}
					}
